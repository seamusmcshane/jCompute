...
public class LogTab extends JPanel implements TailerListener
{
	...
	public LogTab(SimpleTabPanel tabpanel)
	{
		...
		// Size to to n chars what ever font size the LooknFeel is using .
		standardLog.setColumWidth(3, SwingHelper.getInstance().getFontStringWidth(standardLog.getFont(), JCText.CharRepeatBounded('W', 25)));
