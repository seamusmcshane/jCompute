...
public final class JVMInfo
{
	...
	{
		return (int) (Runtime.getRuntime().maxMemory() / NumericConstants.BinaryPrefix.SI_MEGABYTE.byteValue);
	}
	
	public int getTotalJVMMemory()
	{
		return (int) (runtime.totalMemory() / NumericConstants.BinaryPrefix.SI_MEGABYTE.byteValue);
	}
	
	public int getUsedJVMMemory()
	{
		return (int) ((runtime.totalMemory() - runtime.freeMemory()) / NumericConstants.BinaryPrefix.SI_MEGABYTE.byteValue);
	}
	...
	public long getFreeJVMMemory()
	{
		...
		return (int) ((runtime.maxMemory() - used) / NumericConstants.BinaryPrefix.SI_MEGABYTE.byteValue);
	}
