...
public class QuadPanel extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		if(list != null)
		{
			...
			{
				g2.setColor(Color.BLACK);
				g2.drawOval((int) (point.getKNNPos()[0] - pointHalf), (int) (point.getKNNPos()[1] - pointHalf), (int) pointSize,
						(int) pointSize);
			}
		}
		...
		if(searchValidKNN)
		{
			for(KNNPosInf point : nearestNeighbours)
			{
				...
				g2.fillOval((int) (point.getKNNPos()[0] - pointHalf), (int) (point.getKNNPos()[1] - pointHalf), (int) pointSize,
						(int) pointSize);
			}
		}
