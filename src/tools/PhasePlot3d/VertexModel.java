...
public class VertexModel
{
	...
	public void setVertices(float[] vertices,int primitiveType)
	{
		...
		// Indices are shorts and our mesh might exceed Short.MAX_VALUE we may need to split the mesh into sub meshes
        ...
        for(int i=0;i<base;i++)
        {
        	...
        	//System.out.println("MESH " + subVertices.length + " " + subVertices.length/7);
            modelBuilder.part("mesh_"+1, MeshHelper.verticesToMesh(subVertices), primitiveType, new Material(new BlendingAttribute()));
            count ++;            
        }
