...
public class PhasePlotterUtil implements WindowListener, ActionListener
{
	...
	public PhasePlotterUtil()
	{
		...
		// PlotPanel
		plotPanel = new LibGDXGLPanel(glEnv, 0, true, "Phase Plotter");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if((e.getSource() == plotLineWidthButton[0] | e.getSource() == plotLineWidthButton[1] | e.getSource() == plotLineWidthButton[2] | e.getSource() == plotLineWidthButton[3]
				| e.getSource() == plotLineWidthButton[4]))
		{
		...
		else if((e.getSource() == gridLineWidthButton[0] | e.getSource() == gridLineWidthButton[1] | e.getSource() == gridLineWidthButton[2] | e.getSource() == gridLineWidthButton[3]
				| e.getSource() == gridLineWidthButton[4]))
		{
		...
		else if((e.getSource() == minMaxLineWidthButton[0] | e.getSource() == minMaxLineWidthButton[1] | e.getSource() == minMaxLineWidthButton[2] | e.getSource() == minMaxLineWidthButton[3]
				| e.getSource() == minMaxLineWidthButton[4]))
		{
