...
public class SurfacePlotterUtil implements ActionListener, WindowListener
{
	...
	// Allows forcing scale for log created before item info was stored.
	private boolean zMaxFixedForced = true;
	private int zMinForced = 0;
	private int zMaxForced = 10000;
	...
	public void addAvgChart()
	{
		...
		System.out.println(logProcessor.getXValMax());
		System.out.println(logProcessor.getXSteps());
		System.out.println((int) (logProcessor.getXValMax() / (logProcessor.getXSteps() - 1)));
