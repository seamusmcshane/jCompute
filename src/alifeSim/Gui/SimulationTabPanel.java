...
public class SimulationTabPanel extends JPanel
{
	public SimulationTabPanel() {
		...
		gbl_controlPanel.columnWidths = new int[] {112, 112, 112};
		gbl_controlPanel.rowHeights = new int[] {31, 31, 31, 31};
		gbl_controlPanel.columnWeights = new double[]{1.0, 1.0, 1.0};
		...
		gbl_scenarioOpenPanel.rowHeights = new int[] {0};
		gbl_scenarioOpenPanel.columnWidths = new int[] {0, 0, 0};
		gbl_scenarioOpenPanel.columnWeights = new double[]{1.0, 1.0, 1.0};
		gbl_scenarioOpenPanel.rowWeights = new double[]{1.0};
		...
		JEditorPane scenarioEditor = new JEditorPane();
		scenarioEditor.setEditable(false);
		scenarioFilePanel.add(scenarioEditor, BorderLayout.CENTER);
